<?php
include_once("auth_club.php"); //include auth.php file on all secure pages
$page="view_fees";
include_once("connection.php");
include_once("page_title.php");


    $queryForBranch = "SELECT * FROM branch WHERE branch_id = 26 OR branch_id = 53 OR branch_id = 84 OR branch_id = 85;";
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        <?php include_once("side_menu_club.php"); ?>
