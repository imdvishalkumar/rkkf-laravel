...
include_once("page_title.php");
    ...
    $query = " SELECT COUNT(*) AS count FROM students WHERE active = 1 AND belt_id >= 14";
    $result = $con->query($query);

    if ($result) {
        $row = $result->fetch_object();
        $highBeltStudents = $row->count;
    } else {
    ...
    $studentCount1 = $rowForStudentCount->count;
    $studentCount = $studentCount1 -  $highBeltStudents;
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo $highBeltStudents; ?></h3>
                                ...
                                <a href="blackBelt.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                    </div>
