...
// Main query with belt_id = 14 filter
$sql = "SELECT s.*, br.name as branch_name,(select name from belt where belt_id = s.belt_id) as belt_name FROM students s , branch br where s.branch_id = br.branch_id AND s.active = 1 AND s.belt_id = 14";
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Students Belt Details (>14)</h3>
