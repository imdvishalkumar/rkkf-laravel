        ...
        try {
            ...
            return ApiResponseHelper::success([
                $userKey => [
                    ...
                    'mobile' => $user->mobile,
                    'role' => $roleString,
                    'gr_no' => $student ? $student->gr_no : "",
                    'profile_img' => $profileImgUrl,
                    'belt_name' => ($roleString === 'user' && $student && $student->belt) ? $student->belt->name : "",
                    'branch_name' => ($roleString === 'instructor' && $student && $student->branch) ? $student->branch->name : "",
                ],
                'token' => $token,
                'token_type' => 'Bearer',
            ], 'Login successful');
