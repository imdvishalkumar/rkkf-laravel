    ...
    elseif (
        ...
        try {
            ...
            if ( $query_stmtUser->rowCount() > 0 ) {
                ...
                $success_var = false;
                $insert = "INSERT INTO `fastrack_attendance` (`fast_atten_id`, `student_id`, `hours`, `date`, `branch_id`, `user_id`) VALUES (NULL, '".$studentId."', '".$hours."', '".$date."', '".$branchId."', '".$insId."');";
                //echo $insert;
