...
if ( $auth->isAuth() ) {
    ...
    // IF THERE ARE NO EMPTY FIELDS THEN-
        ...
        try {
            ...
            $query = "SELECT * , CONCAT(firstname ,' ',lastname) as name FROM students WHERE CAST(student_id AS VARCHAR(9)) LIKE '".$id."%' or CONCAT(firstname ,' ',lastname) like '%".$id."%' AND active = 1";
