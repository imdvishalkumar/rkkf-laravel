...
if($submitClick) {
	...
	$sql = "select * from users where email = '$email' and password = '$pass' and role = 1";  
		...
		if(is_array($row)) {
            ...
            } else if ($email == "tmc@gmail.com") {
                $_SESSION["tmc"] = "tmc";
                $_SESSION["email"] = $row['email'];
            } else if ($email == "baroda@gmail.com") {
                $_SESSION["baroda"] = "baroda";
                $_SESSION["email"] = $row['email'];
            } else {
...
if(isset($_SESSION["admin"])) {
    ...
    header("Location: club_view_fees.php");
} else if(isset($_SESSION["tmc"])) {
    header("Location: tmc_view_fees.php");
} else if(isset($_SESSION["city"])) {
    header("Location: baroda_view_fees.php");
}
?>
<!DOCTYPE html>
<html lang="en">
