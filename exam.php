...
if ($submitClick)
{
    ...
    else
    {
        ...
        $q = "insert into exam (name,date,sessions_count,fees,fess_due_date,from_criteria,to_criteria) values('$ename','$exam_date','$session_count','$fees','$due_date','$from_date','$to_date')";
