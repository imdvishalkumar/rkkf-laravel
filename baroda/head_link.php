...
$url = $link."://".$_SERVER['SERVER_NAME']."/baroda/";
?>
...
<!-- Title logo -->
<link rel="icon" href="<?php echo $url; ?>logo.jpg" sizes="32x32" />
<link rel="icon" href="<?php echo $url; ?>logo.jpg" sizes="192x192" />
<link rel="apple-touch-icon-precomposed" href="<?php echo $url; ?>logo.jpg" />
