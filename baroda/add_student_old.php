...
if ( $submitClick ) {
    ...
    if ( mysqli_num_rows( $res1 ) > 0 ) {
        ...
        $query = "INSERT INTO `students` (`student_id`, `firstname`, `lastname`, `gender`, `email`, `password`, `belt_id`, `dadno`, `dadwp`, `momno`, `momwp`, `selfno`, `selfwp`, `dob`, `doj`, `address`, `branch_id`, `pincode`, `std`, `active`) VALUES (NULL, '".$fname."', '".$lname."', '".$gender."', '".$email."', '".$hash."', '".$belt."', '".$dmno."', '".$dwno."', '".$mmno."', '".$mwno."', '".$smno."', '".$swno."', '".$dob."', '".$doj."', '".$address."', '".$branch_id."','".$pincode."','".$std."','1');";
        echo $query;
