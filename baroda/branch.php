...
if($submitClick) {
    ...
    else  // add branch
    {
        ...
        $nbfees = ((100/90)*((int)$bfees));
        $rounded = ceil($nbfees / 10) * 10; // Round up to the nearest 10th place
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            $q="insert into branch (name,days,fees,late,discount) values('$bname','$daysStr','$rounded','$blate','$bdiscount')";
