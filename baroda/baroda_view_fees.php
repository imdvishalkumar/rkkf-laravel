<?php
include_once("auth_baroda.php"); //include auth.php file on all secure pages
$page="view_fees";
include_once("connection.php");
include_once("page_title.php");


	$queryForBranch = "SELECT * FROM branch WHERE branch_id >= 57 AND branch_id <= 63;";
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        <?php include_once("side_menu_baroda.php"); ?>
