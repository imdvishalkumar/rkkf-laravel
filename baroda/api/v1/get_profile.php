        ...
        // IF THERE ARE NO EMPTY FIELDS THEN-
            ...
            // THE USER IS ABLE TO PERFORM THE LOGIN ACTION
                ...
                try {
                    ...
                    $query = "SELECT s.*, (SELECT IFNULL(SUM(hours), 0) from fastrack_attendance where student_id = s.student_id) as fast_hrs, b.name as belt , br.name as branch_name ,TIMESTAMPDIFF(YEAR, s.dob, CURDATE()) AS age FROM students s , branch br , belt b where s.branch_id = br.branch_id AND s.active = 1 AND s.belt_id = b.belt_id AND s.student_id= '".$id."'";
