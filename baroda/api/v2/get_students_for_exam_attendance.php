        ...
        // IF THERE ARE NO EMPTY FIELDS THEN-
            ...
            // THE USER IS ABLE TO PERFORM THE LOGIN ACTION
                ...
                try {
                    ...
                    $query = "SELECT s. *, br.name as branch_name FROM students s , branch br , exam_fees ef where s.branch_id = br.branch_id AND s.active = 1 AND ef.student_id = s.student_id AND ef.status = 1 AND ef.exam_id =".$id;
