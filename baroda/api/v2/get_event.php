        ...
        // IF THERE ARE NO EMPTY FIELDS THEN-
            ...
            // THE USER IS ABLE TO PERFORM THE LOGIN ACTION
                ...
                try {
                    ...
                    $eligibleAtten = false;
                    $dueDateGone = false;
                    $query = "SELECT e.*, EXISTS (SELECT event_fees_id from event_fees WHERE student_id = ".$id." AND e.event_id = event_id AND status = 1) as applied from event e WHERE e.from_date > CURDATE() AND e.penalty_due_date >= CURDATE() AND e.event_id = s.event_id AND s.student_id = ".$id."";                    
