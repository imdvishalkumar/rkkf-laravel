...
if ( $_POST ) {
    ...
    if ( isset( $_POST['branchId'] ) ) {
        ...
        if ( !( empty( $branchId ) ) ) {
            $sql = "SELECT CONCAT(s.firstname, ' ' , s.lastname) as name,s.student_id, s.active, a.* FROM students s, exam_attendance a WHERE s.student_id = a.student_id AND a.exam_id = ".$branchId;
