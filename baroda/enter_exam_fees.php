...
if($submitClick) {
    ...
    $q = "INSERT INTO `exam_fees` (`exam_fees_id`, `exam_id`, `student_id`, `date`, `mode`, `rp_order_id`, `status`, `amount`, `exam_belt_id`) VALUES (NULL, '".$exam_id."', '".$id."', CURDATE(), 'manual', '".$remarks."', '1', '".$amount."', '".$belt_id."')";
        $result = $con->query($q);
        if($result)
        {
            $alertMsg = "
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script>
        ...
        function get_studentInfo() { // Call to ajax function
            ...
            $.ajax({
                type: "POST",
                url: "enter_exam_fees_ajax.php", // Name of the php files
                data: dataString,
