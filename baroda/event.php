...
if ($submitClick)
{
    ...
    {
        $q = "insert into event (name,from_date,to_date,venue,type,description,fees,fees_due_date,penalty,penalty_due_date) values('$ename','$fromDate','$toDate','$venue','$type','$desc','$rounded','$feesDueDate','$penaltyFees','$penaltyDueDate')";
