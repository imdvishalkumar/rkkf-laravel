                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 my-auto">
                                                        <div class="input-group date" id="startdate" data-target-input="nearest">
                                                            <input type="text" placeholder="From Date" class="form-control datetimepicker-input" data-target="#startdate" name="startdate" onchange="get_studentInfo()" required />
                                                    ...
                                                    <div class="col-sm-4 my-auto">
                                                        <div class="input-group date" id="enddate" data-target-input="nearest">
                                                            <input type="text" placeholder="To Date" class="form-control datetimepicker-input" data-target="#enddate" name="enddate" onchange="get_studentInfo()" required />
     ...
     <script>
        ...
        function get_studentInfo() { // Call to ajax function
            ...
            var enddate = $("input[name=enddate]").val();
                ...
                $.ajax({
                    type: "POST",
                    url: "deactive_report_ajax.php", // Name of the php files
                    data: {
                        branch_id: branchId,
