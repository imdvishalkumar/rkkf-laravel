...
if($delClick) {
	...
	$sql = "select f.* ,concat(s.firstname,' ',s.lastname) as name , c.amount as discount from fees f, students s, coupon c WHERE f.student_id = s.student_id AND f.coupon_id = c.coupon_id AND f.disabled = 1";
