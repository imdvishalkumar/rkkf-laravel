                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 my-auto">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" id="exam_atten" name="exam_atten" placeholder="Session Count" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-1">
                                                        <button type="button" class="btn btn-primary btn-sm" onclick="get_studentInfo()">
            ...
            if (startdate && enddate){
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#infoDiv').append(html); // Assuming 'infoDiv' is the ID of the parent container

                        // Reinitialize DataTable on the new table structure
                        $('#example1').DataTable({
                            "responsive": true,
                            "lengthChange": false,
                            "autoWidth": false,
