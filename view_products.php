  ...
  while($row = $result->fetch_assoc()) {
    echo "<tr id='".$row['product_id']."'>  
          ...
          <div class='text-center'>
				...
				<button id='btnModal' value='".$row['product_id']."' onclick='passId(this.value)' data-toggle='modal'  data-target='#deleteModal' class='delete-user action-icon' style='padding: 0;border: none;background: none;'><span class='fas fa-trash'></span></button>
